    ...
    return (
        <div className='mx-auto my-4 container'>
            <div className="input-group my-2 ">
                ...
                <input style={{ backgroundColor: 'rgba(255, 255, 255 ,0.05 )', color: '#1976d2', border: "1px solid rgba(25, 118, 210, 0.5)" }} id="kos" className="" type="text" placeholder="Search for any passport name, gender or country" value={searchValue} onChange={handleChange} className="form-control" aria-label="" aria-describedby="basic-addon1" />
